...
#' Calculation of the tonne of Carbon instead of CO2 Emissions yearly
#'
...
Kaya_equation_C <- function(pop, gdp, enInt, carbInt, output_type = "CO2") {
...
Kaya_equation_C(82.4,44,5,0.05, "C")
# 246.9755
